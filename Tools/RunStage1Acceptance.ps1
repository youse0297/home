...
Add-ScriptGate -Name 'Edge Wear' `
    -ScriptName 'ValidateEdgeWear.ps1' `
...
Add-ScriptGate -Name 'Unified Material Interface' `
    -ScriptName 'ValidateUnifiedMaterialInterface.ps1' `
